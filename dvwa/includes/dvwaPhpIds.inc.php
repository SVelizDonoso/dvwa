...
function dvwaClearIdsLog()	{
	if( isset( $_GET[ 'clear_log' ] ) ) {
		...
		fclose( $fp );
		dvwaMessagePush( "PHPIDS log Limpiados" );
		dvwaPageReload();
	}
}
	...
	try {
		...
		*/
		...
		if( !$result->isEmpty() ) {
			...
			echo 'Intento de Hackeo detectado y registrado.<br />Que tengas un buen día.';
		...
		printf( 'A Ocurrido un Error: %s', $e->getMessage() );
	}
}
