...
$page[ 'title' ]   = 'Vulnerabilidad: Inyección de SQL (Ciegas)' . $page[ 'title_separator' ].$page[ 'title' ];
...
if( ini_get( 'magic_quotes_gpc' ) == true ) {
	$WarningHtml .= "<div class=\"warning\">La Función PHP \"<em>Magic Quotes</em>\" está Habilitada.</div>";
}
// Is PHP function safe_mode enabled?
if( ini_get( 'safe_mode' ) == true ) {
	$WarningHtml .= "<div class=\"warning\">La Función PHP  \"<em>Safe mode</em>\" está Habilitad.</div>";
}

$page[ 'body' ] .= "
<div class=\"body_padded\">
	<h1>Vulnerabilidad: Inyección de SQL (Ciegas)</h1>

	{$WarningHtml}

	<div class=\"vulnerable_code_area\">";
if( $vulnerabilityFile == 'high.php' ) {
	$page[ 'body' ] .= "Click <a href=\"#\" onclick=\"javascript:popUp('cookie-input.php');return false;\">aquí para cambiar su identificación</a>.";
}
else {
	$page[ 'body' ] .= "
