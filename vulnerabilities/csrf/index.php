...
$page[ 'title' ]   = 'Vulnerabilidad: Falsificación de Solicitud Cruzada de Sitio (CSRF)' . $page[ 'title_separator' ].$page[ 'title' ];
$page[ 'page_id' ] = 'csrf';
...
<div class=\"body_padded\">
	<h2>Vulnerabilidad: Falsificación de Solicitud Cruzada de Sitio (CSRF)</h2>
