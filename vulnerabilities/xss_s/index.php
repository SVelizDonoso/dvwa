...
$page[ 'title' ]   = 'Vulnerabilidad: Cross Site Scripting (Almacenado)' . $page[ 'title_separator' ].$page[ 'title' ];
$page[ 'page_id' ] = 'xss_s';
...
<div class=\"body_padded\">
	<h1>Vulnerabilidad: Cross Site Scripting (Almacenado)</h1>
		...
		<form method=\"post\" name=\"guestform\" \">
			<table width=\"550\" border=\"0\" cellpadding=\"2\" cellspacing=\"1\">
				...
				<tr>
					<td width=\"100\">&nbsp;</td>
					<td>
						<input name=\"btnSign\" type=\"submit\" value=\"Firmar libro de visitas\" onclick=\"return validateGuestbookForm(this.form);\" />
						<input name=\"btnClear\" type=\"submit\" value=\"Limpiar libro de visitas\" onClick=\"return confirmClearGuestbook();\" />
					</td>
				</tr>
			</table>\n";
