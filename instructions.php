...
$page[ 'title' ]   = 'Instrucciones' . $page[ 'title_separator' ].$page[ 'title' ];
$page[ 'page_id' ] = 'instructions';

$docs = array(
	'readme'         => array( 'legend' => 'Léeme', 'file' => 'README.md' ),
	'PDF'            => array( 'legend' => 'Guía PDF', 'file' => 'docs/pdf.html' ),
	'changelog'      => array( 'legend' => 'Log de cambios', 'file' => 'CHANGELOG.md' ),
	'copying'        => array( 'legend' => 'Copying', 'file' => 'COPYING.txt' ),
	'PHPIDS-license' => array( 'legend' => 'PHPIDS Licencia', 'file' => DVWA_WEB_PAGE_TO_PHPIDS . 'LICENSE' ),
);
